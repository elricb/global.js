...
if (typeof jQuery=='function') {
    ...
    Elements.loading.img.show=function(){Elements.loading.img.length&&Elements.loading.img.fadeIn()};
    Elements.loading.img.hide=function(){Elements.loading.img.length&&Elements.loading.img.fadeOut()};
