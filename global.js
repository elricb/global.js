...
if (typeof jQuery=='function') {
    ...
    Elements.unifyDimensions=function(a,b,c){var d=0,e=0;b=Cast.cboolean(b,!0);c=Cast.cboolean(c,!0);a=Cast.cjquery(a);a.each(function(){ajqo=$(this);ajqo.width()>d&&(d=Math.max(ajqo.width(),ajqo.outerWidth()));ajqo.height()>e&&(e=Math.max(ajqo.height(),ajqo.outerHeight()))});a.each(function(){ajqo=$(this);b&&ajqo.width(d);c&&ajqo.height(e)});return a};
