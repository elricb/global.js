...
var Cast={
    ...
    carray:function(a, b){"undefined"==typeof b&&(b=[]);if("undefined"==typeof a||!a)return b;if(this.isArray(a))return a;if("function"==typeof a.toArray)return a.toArray();if("object"==typeof a.toArray){b=[];for(var c in a)b.push(a[c]);return b}return[a]},
